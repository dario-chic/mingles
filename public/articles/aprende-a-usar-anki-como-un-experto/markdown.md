# GUÍA PARA APRENDER IDIOMAS CON ANKI
...
La repetición espaciada es especialmente eficaz y útil cuando se quiere aprender permanentemente una gran cantidad de elementos distintos. Como fórmulas matemáticas o el vocabulario de una lengua extranjera.
...
Esta guía es una guía basada en mi experiencia personal, creada a partir de prueba y error, y en lo que personalmente más me ha funcionado para obtener los mejores resultados a lo largo de todo el tiempo que he usado Anki, está totalmente sujeto a cambios y los ajustes que veas más óptimo para ti.
...
- **Mazo de Vocabulario:** Este mazo es el más primordial, por así decirlo, aquí vas a agregar todas las palabras nuevas que vayas aprendiendo a medida que realizas el input.

- **Mazo de Phrasal Verbs:** La comunicación en inglés se basa mayormente en phrasal verbs, los phrasal verbs son la unión de 2 o más palabras/verbos de la cual se obtienen significados totalmente distinto.

- **Fluent Expression:** Otro mazo que considero importante son las expresiones o "idioms", las cuales son básicamente frases o expresiones que en español conocemos como "modismos", son frases que tienen un significado figurativo. Por ejemplo, un modismo de mi país es "Estar limpio", que puede significar "No tener dinero".

Por supuesto puedes agregar tantos mazos como te plazca, para las cosas que te plazca, de hecho yo tengo un par más para practicar la pronunciación y el "listening", sin embargo, considero los mazos que enliste lo más importantes, ya que es el contenido que más te encuentras en cualquier idioma y por ende necesitas aprenderlo para poder entender mejor y comunicarte mejor.

![Seleccionar mazo en anki](/articles/aprende-a-usar-anki-como-un-experto/anki5.webp)

Por otro lado, si prefieres tener todo en un solo mazo, también está bien, es totalmente válido, esta es solo mi recomendación y lo que pienso funciona mejor.

---

### Como crear buenas cards

Hay una forma que considero la mas optima para crear las cards, colocando la información adecuada para mejorar el aprendizaje. Cuando estés viendo tu serie favorita y veas una nueva palabra o expresion, harás lo siguiente:
...
**¿Por qué hacerlo de esta manera y no simplemente escribir la palabra?**

Más que solo el significado de la palabra, queremos entender la idea y el uso de la misma, y para ello necesitamos el contexto.

El contexto es lo que está sucediendo en el momento que se dice la oración, quizás en la serie el personaje está disfrutando algo, está feliz y entonces dice "This is **nice**!", esta situación nos da a entender que "**nice**" es una palabra que expresa que algo es agradable y que puedes usarla cuando pienses que algo es cool, aprender por contexto hace que recordar el vocabulario sea más sencillo.
...
Y lo más importante, y es algo que no hay que olvidar es que una misma palabra, phrasal verb o expresion puede usarse para expresar cosas totalmente distintas, donde todo siempre dependerá del contexto. De hecho, en mis mazos tengo variedad de cards, para una misma palabra, pero con diferentes contextos y significados.

Un ejemplo de esto es la palabra book:

> I’m reading a book about psychology / Estoy leyendo un libro sobre psicología **( Aquí book significa libro )**
>
> I’m going to book a table for dinner. Is 9 PM okay? / Voy a reservar una mesa para cenar, ¿está bien a las 9pm? **( Y aquí book significa reservar )**

También puedes observar que en la captura coloque el significado en inglés, esto también es sumamente importante, ya que no queremos traducir, queremos entender la idea de la palabra y que mejor forma de hacerlo que viendo qué descripción le dan ellos mismos a la palabra. Entiendo que esto para nuevos puede ser algo difícil, porque con poco vocabulario, es difícil entender estos mismos conceptos en inglés, sin embargo, aun así trata de no traducir, puedes colocar el significado en español, pero investigando en google algo como "Qué significa "nice"?", para que de igual manera obtengas el significado de la idea en sí, sin asociarlo a alguna palabra en español.
...
El paso final y el más fácil es estudiar y repasar los mazos que anteriormente creaste. Trata de hacerlo sin falta cada día por lo menos una o dos veces diarias, aunque lo mejor sería hacerlo cada vez que tengas cartas nuevas por aprender o repasar, tratar de que todos los mazos siempre estén en 0.

Esto no es una competencia ni nada por el estilo., así que se sincero con las respuestas que das, y recuerda solo usar la opción de again/de nuevo y good/bien. Si batallaste un poco para poder recordar, dale en again y aunque haya sido muy fácil de recordar, dale en good.

Ya con todo esto estás listo para empezar a usar Anki, esta es una guía muy básica y como empecé yo con Anki. La realidad es que con Anki se pueden hacer muchísimas más cosas, desde agregar imágenes y audios, hasta personalizar tus cartas para que luzcan increíbles, este es un mazo configurado por mí:

Como puedes observar, luce bastante mejor y más agradable que la forma básica y tiene muchas más opciones, como ver ejemplos, ver otros conceptos y lo mejor es que tiene audio para practicar el listening. En un futuro planeo crear una guía más avanzada donde te enseñaré como hacer cards así de geniales y aumentar exponencialmente tu progreso con Anki, por ahora con esto es suficiente.

Esto junto con la guía para aprender inglés es todo lo que necesitas para adquirir cualquier Idioma de una forma muy fácil, rapida y eficaz, te deseo la mejor de las suertes y espero que en unos meses logres todos tus objetivos.

También te espero en la comunidad de Discord para practicar el progreso, **see you later!**
