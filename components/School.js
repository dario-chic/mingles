...
const description = `Es importante que sepas que no somos una escuela, no damos clases ni parecido a los métodos convencionales. Sin embargo, somos conscientes de que puede ser realmente complicado <span class="bold">aprender un idioma de forma correcta</span>, es por eso que hemos creamos nuestra "escuela". 
