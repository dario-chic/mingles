...
Primero, es importante aclarar que realmente <span class="bold">no somos una escuela</span>, somos una comunidad. No impartimos clases para enseñarte gramática, listas de vocabulario ni nada parecido a los métodos convencionales. Nuestros métodos de enseñanza y aprendizaje van mucho más allá de todo eso.
...
Nuestra escuela se encarga de enseñarte el "secreto" o mejor dicho, el mejor camino para aprender un idioma. Aquí encontrarás guías que hemos desarrollado para ayudarte y guiarte en tu proceso de aprendizaje, para que lo realices de una forma rápida, eficaz y que realmente te de buenos resultados. 
